...
# diff_after_tuning = grid.best_score_/accuracy * 100
# print(f"Grid best score: {grid.best_score_:.3f}")
# print(f"Difference after tuning: {diff_after_tuning:.1f} %")
...
# TODO: sort according to accuracy
results.sort(reverse=False, key=lambda e: e['Accuracy'])

for r in results:
    print(r["Classifier"], end="\t\t")
    print(r["Accuracy"], end="\t\t")
